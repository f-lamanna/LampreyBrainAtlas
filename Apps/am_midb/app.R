#setwd("~/LampreyBrainApps/Apps/am_midb/")
source(file = "prepare_env.R")

# User interface (client)
ui <- navbarPage(title = "LarvalMesencephalon", 
                 id = "lb",
                 position = "fixed-top",
                 theme = "bootstrap_am_midb.css",
                 ...
                 tabPanel(title = "Taxonomy",
                          ...
                          wellPanel(fluidRow(column(width = 2,
                                             ...
                                             column(width = 10,
                                                    collapsibleTreeOutput(outputId = "plot", 
                                                                          height = "800px",
                                                                          width = "auto") %>% withSpinner(color= "#97607A")))),
                          # Horizontal line
                          hr(),
                          ...
                          fluidRow(column(width = 4,
                                          offset = 2,
                                          plotlyOutput(outputId = "seurat_umap_2d") %>% withSpinner(color= "#97607A")),
                                   column(width = 4,
                                          plotlyOutput(outputId = "seurat_tsne_2d") %>% withSpinner(color= "#97607A")))
                 ...
                 tabPanel(title = "Clusters",
                          ...
                          fluidRow(column(width = 2,
                                          ...
                                          sliderInput(inputId = "p_size_c",
                                                      ...
                                                      step = 0.5)),
                                   column(width = 5,
                                          plotlyOutput(outputId = "seurat_umap_2d_c") %>% withSpinner(color= "#97607A")),
                                   column(width = 5,
                                          plotlyOutput(outputId = "seurat_tsne_2d_c") %>% withSpinner(color= "#97607A"))

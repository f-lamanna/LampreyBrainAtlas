#setwd("~/LampreyBrainApps/Apps/am_hind/")
source(file = "prepare_env.R")

# User interface (client)
ui <- navbarPage(title = "LarvalRhombencephalon", 
                 id = "lb",
                 position = "fixed-top",
                 theme = "bootstrap_am_hind.css",
                 ...
                 tabPanel(title = "Taxonomy",
                          ...
                          wellPanel(fluidRow(column(width = 2,
                                             ...
                                             column(width = 10,
                                                    collapsibleTreeOutput(outputId = "plot", 
                                                                          height = "800px",
                                                                          width = "auto") %>% withSpinner(color= "#B1965E")))),
                          # Horizontal line
                          hr(),
                          ...
                          fluidRow(column(width = 4,
                                          offset = 2,
                                          plotlyOutput(outputId = "seurat_umap_2d") %>% withSpinner(color= "#B1965E")),
                                   column(width = 4,
                                          plotlyOutput(outputId = "seurat_tsne_2d") %>% withSpinner(color= "#B1965E")))
                 ...
                 tabPanel(title = "Clusters",
                          ...
                          fluidRow(column(width = 2,
                                          ...
                                          sliderInput(inputId = "p_size_c",
                                                      ...
                                                      step = 0.5)),
                                   column(width = 5,
                                          plotlyOutput(outputId = "seurat_umap_2d_c") %>% withSpinner(color= "#B1965E")),
                                   column(width = 5,
                                          plotlyOutput(outputId = "seurat_tsne_2d_c") %>% withSpinner(color= "#B1965E"))
